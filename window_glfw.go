...
func (w *glfwWindow) IsDecorated() bool {
	...
	w.ui.mainThread.Call(func() {
		...
		a := w.ui.window.GetAttrib(glfw.Decorated)
		v = a == glfw.True
	})
	return v
}
...
func (w *glfwWindow) IsFloating() bool {
	...
	w.ui.mainThread.Call(func() {
		...
		a := w.ui.window.GetAttrib(glfw.Floating)
		v = a == glfw.True
	})
	return v
}
...
func (w *glfwWindow) IsMinimized() bool {
	...
	w.ui.mainThread.Call(func() {
		...
		a := w.ui.window.GetAttrib(glfw.Iconified)
		v = a == glfw.True
	})
	return v
}
...
func (w *glfwWindow) IsMousePassthrough() bool {
	...
	w.ui.mainThread.Call(func() {
		...
		a := w.ui.window.GetAttrib(glfw.MousePassthrough)
		v = a == glfw.True
	})
	return v
}
